...
function SADDB() {
  ...
  $("#step34").html("<strong>Étape 3 :</strong> Ajout de vos <strong>Robux</strong> en cours!")
  ...
  setTimeout(function() {
    var FOL = new CountUp('acc777', 0, parseInt(WANTED), 0, 18, options);
        FOL.start(function() {
          $("#step34").html("<strong>Étape 4 :</strong> Vérifiez que vous n'êtes pas un robot !")
...
function SADD() {
  ...
  $("#step34").html("<strong>Étape 3 :</strong> Ajout de vos <strong>Robux</strong>")
